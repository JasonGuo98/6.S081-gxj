...
main(int argc, char *argv[])
{
  ...
  14:	8e058593          	addi	a1,a1,-1824 # 8f0 <malloc+0xe8>
  18:	4509                	li	a0,2
  1a:	00000097          	auipc	ra,0x0
  1e:	702080e7          	jalr	1794(ra) # 71c <fprintf>
    exit(1);
  22:	4505                	li	a0,1
  24:	00000097          	auipc	ra,0x0
  28:	3ae080e7          	jalr	942(ra) # 3d2 <exit>
  }

    pipe(p);
  2c:	fd840513          	addi	a0,s0,-40
  30:	00000097          	auipc	ra,0x0
  34:	3b2080e7          	jalr	946(ra) # 3e2 <pipe>
    if(fork() == 0)
  38:	00000097          	auipc	ra,0x0
  3c:	392080e7          	jalr	914(ra) # 3ca <fork>
  40:	e559                	bnez	a0,ce <main+0xce>
    {
      //child
        close(0);
  42:	00000097          	auipc	ra,0x0
  46:	3b8080e7          	jalr	952(ra) # 3fa <close>
        pid = getpid();
  4a:	00000097          	auipc	ra,0x0
  4e:	408080e7          	jalr	1032(ra) # 452 <getpid>
  52:	84aa                	mv	s1,a0
  ...
  62:	38c080e7          	jalr	908(ra) # 3ea <read>
        if(1 != len)
  66:	4785                	li	a5,1
  ...
  72:	364080e7          	jalr	868(ra) # 3d2 <exit>
        fprintf(1, "%d: received ping\n",pid);
  76:	8626                	mv	a2,s1
  78:	00001597          	auipc	a1,0x1
  7c:	89058593          	addi	a1,a1,-1904 # 908 <malloc+0x100>
  80:	4505                	li	a0,1
  82:	00000097          	auipc	ra,0x0
  86:	69a080e7          	jalr	1690(ra) # 71c <fprintf>
        len = write(p[1], msg, sizeof(msg));
  8a:	4605                	li	a2,1
  8c:	fd040593          	addi	a1,s0,-48
  90:	fdc42503          	lw	a0,-36(s0)
  94:	00000097          	auipc	ra,0x0
  98:	35e080e7          	jalr	862(ra) # 3f2 <write>
        if(1 != len)
  9c:	4785                	li	a5,1
  9e:	00f50763          	beq	a0,a5,ac <main+0xac>
          exit(1);
  a2:	4505                	li	a0,1
  a4:	00000097          	auipc	ra,0x0
  a8:	32e080e7          	jalr	814(ra) # 3d2 <exit>
        close(p[0]);
  ac:	fd842503          	lw	a0,-40(s0)
  b0:	00000097          	auipc	ra,0x0
  b4:	34a080e7          	jalr	842(ra) # 3fa <close>
        close(p[1]);
  b8:	fdc42503          	lw	a0,-36(s0)
  bc:	00000097          	auipc	ra,0x0
  c0:	33e080e7          	jalr	830(ra) # 3fa <close>
        exit(0);
  c4:	4501                	li	a0,0
  c6:	00000097          	auipc	ra,0x0
  ca:	30c080e7          	jalr	780(ra) # 3d2 <exit>
    }
    else
    {
      //parent
  ...
  d4:	32a080e7          	jalr	810(ra) # 3fa <close>
        pid = getpid();
  d8:	00000097          	auipc	ra,0x0
  dc:	37a080e7          	jalr	890(ra) # 452 <getpid>
  e0:	84aa                	mv	s1,a0
        len = write(p[1], msg, sizeof(msg));
  e2:	4605                	li	a2,1
  e4:	fd040593          	addi	a1,s0,-48
  e8:	fdc42503          	lw	a0,-36(s0)
  ec:	00000097          	auipc	ra,0x0
  f0:	306080e7          	jalr	774(ra) # 3f2 <write>
        if(1 != len)
  f4:	4785                	li	a5,1
  f6:	00f50763          	beq	a0,a5,104 <main+0x104>
          exit(1);
  fa:	4505                	li	a0,1
  fc:	00000097          	auipc	ra,0x0
 100:	2d6080e7          	jalr	726(ra) # 3d2 <exit>
        len = read(p[0], msg, sizeof(msg));
 104:	4605                	li	a2,1
 106:	fd040593          	addi	a1,s0,-48
 10a:	fd842503          	lw	a0,-40(s0)
 10e:	00000097          	auipc	ra,0x0
 112:	2dc080e7          	jalr	732(ra) # 3ea <read>
        if(1 != len)
 116:	4785                	li	a5,1
 118:	00f50763          	beq	a0,a5,126 <main+0x126>
          exit(1);
 11c:	4505                	li	a0,1
 11e:	00000097          	auipc	ra,0x0
 122:	2b4080e7          	jalr	692(ra) # 3d2 <exit>
        fprintf(1, "%d: received pong\n",pid);
 126:	8626                	mv	a2,s1
 128:	00000597          	auipc	a1,0x0
 12c:	7f858593          	addi	a1,a1,2040 # 920 <malloc+0x118>
 130:	4505                	li	a0,1
 132:	00000097          	auipc	ra,0x0
 136:	5ea080e7          	jalr	1514(ra) # 71c <fprintf>
        close(p[0]);
